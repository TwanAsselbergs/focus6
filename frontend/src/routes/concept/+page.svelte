      ...
      <div class="relative w-full mx-auto">
         ...
         <div class="absolute inset-0 rounded-3xl text-white pl-4 pt-16 md:pt-24 md:pl-48"
            ...
            <div class="w-full md:w-2/3 flex justify-center items-center md:items-start flex-col md:flex-none"
               ...
               <p class="w-11/12 md:w-2/4 text-center md:text-left text-lg md:text-base pt-4 pb-8 [text-shadow:_0_2px_4px_rgb(0_0_0_/_1)]">
   ...
   <section class="mb-16 relative">
      <div class="relative w-full mx-auto">
         ...
         <div class="absolute inset-0 rounded-3xl text-white pl-4 pt-16 md:pt-24 md:pl-48"
            ...
            <div class="w-full md:w-2/3 flex justify-center items-center md:items-start flex-col md:flex-none"
               >
               <h2 class="text-4xl md:text-7xl font-semibold pb-4 [text-shadow:_0_2px_4px_rgb(0_0_0_/_1)] text-center md:text-left">Implementatie</h2>
               <p class="w-11/12 md:w-2/4 text-center md:text-left text-lg md:text-base pt-4 pb-8 [text-shadow:_0_2px_4px_rgb(0_0_0_/_1)]">
