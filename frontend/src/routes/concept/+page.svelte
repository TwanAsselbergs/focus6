...
<main class="mt-24">
  ...
  >
    ...
    <p class="text-gray-400 font-semibold">Over ons spiegelconcept</p>
  </div>
  ...
  <section class="mt-32">
    ...
    >
      ...
      <div class="text-center md:w-1/3 md:ml-36">
        ...
        <p class="w-full text-center mx-auto text-lg">
          ...
          de teams opereren is complex en clienten en stakeholders zijn
          kritisch. Van het team vraagt dit daadkracht, professionaliteit en
          flexibliteit. Op een praktische en speelse manier helpen we teams om
          ...
          manager, professional of ondersteuner bent. <span> </span>
        </p>
      </div>
    </div>
  </section>
  ...
  <section>
    ...
    >
      ...
      <div class="text-center md:w-1/3 md:ml-36">
        ...
        <p class="w-10/12 flex justify center items-center mx-auto text-lg">
      ...
      >
        ...
        >
          ...
          >
            ...
            <p
              class="w-11/12 md:w-2/4 text-center md:text-left text-lg md:text-base pt-4 pb-8 [text-shadow:_0_2px_4px_rgb(0_0_0_/_1)]"
            >
